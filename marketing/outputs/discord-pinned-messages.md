# RillCoin Discord — Pinned Messages

> Production-ready pinned message content for every channel that requires one.
> Each entry is labeled with the target channel and message number where a channel requires multiple pins.
> Discord's 2,000-character limit is respected — messages that exceed it are split and labeled accordingly.
...
### #roles-and-verification — Pinned Message 1 of 2
...
### #roles-and-verification — Pinned Message 2 of 2
...
### #price-and-markets — Pinned Message 1 of 1
...
### #protocol — Pinned Message 1 of 2
...
### #protocol — Pinned Message 2 of 2
...
### #development — Pinned Message 1 of 1
...
### #research — Pinned Message 1 of 1
...
### #node-operators — Pinned Message 1 of 2
...
### #node-operators — Pinned Message 2 of 2
...
### #testnet-general — Pinned Message 1 of 1
...
### #bug-reports — Pinned Message 1 of 1
...
### #governance-general — Pinned Message 1 of 1
...
### #proposals — Pinned Message 1 of 1
...
### #support-general — Pinned Message 1 of 1
...
### #bot-commands — Pinned Message 1 of 1
...
*Review and update when protocol parameters change, role structure changes, or Discord's markdown rendering changes significantly.*
*All placeholder links marked `URL_PLACEHOLDER` must be replaced with live URLs before the server goes public.*
