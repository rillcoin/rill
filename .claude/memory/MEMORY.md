...
## Current State
- **Phase:** Phase 1 — All 6 library crates complete
...
## What's Next
1. **bins/rill-node** — Wire up Node + RPC + CLI args (clap)
2. **bins/rill-miner** — Mining loop: template → mine → submit
3. **bins/rill-cli** — Wallet CLI: create, address, send via RPC
4. Private testnet milestone: multi-node, mine, transact
